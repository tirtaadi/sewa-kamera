<?php
$produk = file_get_contents('data/camera.json');
        ...
        <div class="small-container">
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <h5><?= $row["NAMA_CAMERA"] ?></h5>
                    <h4><?= $row["DESKRIPSI_CAMERA"] ?></h4>
                    <p>Rp. 90.000/Day</p>
                </div>
                <?php endforeach; ?>
            </div>   
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">?= $row["NAMA_CAMERA"] ?></h5>
                        <p class="card-text">?= $row["DESKRIPSI_CAMERA"] ?></p>
